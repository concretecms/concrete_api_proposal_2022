...
use Concrete\Proposals\Api\Attribute\AttributeValueMapFactory;
use Concrete\Proposals\Api\File\Search\ColumnSet\Column\FileVersionDateAddedColumn;
use Concrete\Proposals\Api\Fractal\Transformer\FileTransformer;
...
class Files extends ApiController
{
    ...
    /**
     * @OA\Get(
     *     path="/ccm/api/proposed/files/{fileID}",
     *     tags={"files"},
    ...
    /**
     * @OA\Post(
     *     path="/ccm/api/proposed/files/{fileID}/move",
     *     tags={"files"},
