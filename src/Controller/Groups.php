...
use Concrete\Proposals\Api\Group\Search\ColumnSet\Column\GroupIdColumn;
use Concrete\Proposals\Api\Fractal\Transformer\GroupTransformer;
...
class Groups extends ApiController
{
    ...
    /**
     * @OA\Get(
     *     path="/ccm/api/proposed/groups/{groupID}",
     *     tags={"groups"},
