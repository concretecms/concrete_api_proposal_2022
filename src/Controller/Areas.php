...
use Concrete\Proposals\Api\Area\Exception\AreaNotFoundException;
use Concrete\Proposals\Api\Block\Exception\BlockNotFoundException;
use Concrete\Proposals\Api\Block\Traits\GetBlockToEditTrait;
use Concrete\Proposals\Api\Block\Traits\ValidateBlockRequestTrait;
use Concrete\Proposals\Api\Command\AddBlockToPageCommand;
use Concrete\Proposals\Api\Command\DeleteBlockCommand;
use Concrete\Proposals\Api\Command\UpdatePageBlockCommand;
use Concrete\Proposals\Api\Fractal\Transformer\BaseBlockTransformer;
...
class Areas extends ApiController implements ApplicationAwareInterface
{
    ...
    /**
     * @OA\Post(
     *     path="/ccm/api/proposed/pages/{pageID}/{areaHandle}",
     *     tags={"areas"},
    ...
    /**
     * @OA\Delete(
     *     path="/ccm/api/proposed/pages/{pageID}/{areaHandle}/{blockID}",
     *     tags={"areas"},
