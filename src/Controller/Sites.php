...
use Concrete\Proposals\Api\Fractal\Transformer\SiteTransformer;
...
class Sites extends ApiController
{
    ...
    /**
     * @OA\Get(
     *     path="/ccm/api/proposed/sites/{siteID}",
     *     tags={"sites"},
    ...
    /**
     * @OA\Get(
     *     path="/ccm/api/proposed/sites/default",
     *     tags={"sites"},
